    ...
    <div className={styles.layout_spacing}>
      ...
      <div className={styles.padding_bottom_md}>
        ...
        <div className={styles.padding_bottom_md}>
          ...
          <p>
            In no case shall us, our directors, officers, employees, affiliates,
        ...
        <div className={styles.padding_bottom_md}>
          ...
          <p>
            You agree to indemnify, defend and hold us harmless and our parent,
        ...
        <div className={styles.padding_bottom_md}>
          ...
          <p>
            ...
            accordance with the laws of ALPHARETTA, GA, 30004, United States.
          </p>
        </div>
        <div className={styles.padding_bottom_md}>
          <p className={styles.padding_bottom_sm}>
